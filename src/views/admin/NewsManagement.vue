    ...
    <div class="rounded-2xl border border-gray-200 bg-white shadow-theme-sm dark:border-gray-800 dark:bg-white/[0.03] overflow-hidden">
      ...
      <div v-else-if="filteredNews.length === 0" class="p-16 text-center">
        <div class="max-w-md mx-auto">
          ...
          <h3 class="text-xl font-bold text-gray-900 dark:text-white/90 mb-2">No News Articles Yet</h3>
          <p class="text-gray-500 dark:text-gray-400 mb-6">Get started by creating your first news article to share with your community.</p>
          <button
            @click="openModal()"
