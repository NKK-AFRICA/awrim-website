<template>
  <div class="space-y-6">
    ...
    <div class="rounded-2xl border border-gray-200 bg-white shadow-theme-sm dark:border-gray-800 dark:bg-white/[0.03] overflow-hidden">
      ...
      <div v-else-if="filteredResources.length === 0" class="p-16 text-center">
        <div class="max-w-md mx-auto">
          <div class="w-20 h-20 bg-gray-100 dark:bg-gray-800 rounded-full flex items-center justify-center mx-auto mb-6">
            <i class="fas fa-file-alt text-3xl text-gray-400"></i>
          </div>
          <h3 class="text-xl font-bold text-gray-900 dark:text-white/90 mb-2">No Publications Yet</h3>
          <p class="text-gray-500 dark:text-gray-400 mb-6">Share important documents, reports, and resources with your community by adding publications.</p>
          <button
            @click="openModal()"
